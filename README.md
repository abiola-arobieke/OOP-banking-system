...
<div align="center">
  <h3><b>OOP Banking System README</b></h3>
</div>
...
# 📖 [OOP Banking System] <a name="about-project"></a>

**OOP Banking System** is an object oriented programming for banking system
...
```sh
  git clone https://github.com/abiola-arobieke/OOP-banking-system.git
```
...
```sh
    Install code runner on your code editor extension. Open the app.py file, then click 
    the play button on the right side of your code editor and view the result on your code editor output.
```
...
- [ ] **Transform to a web banking app**
- [ ] **Create a database for the banking app**
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/OOP-banking-system/issues).
